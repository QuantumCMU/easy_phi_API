...
class DecoratorsTest(unittest.TestCase):
    ...
    def test_format_conversion_dict(self):
        ...
        response_text, ctype = \
            decorators.format_conversion({'one': 1, 2: None}, 'plain')
        self.assertTrue("one: 1\n2: None" == response_text or
                        "2: None\none: 1" == response_text)

        # dicttoxml does not support integer indices
        response_text, ctype = \
            decorators.format_conversion({'one': 1, '45': None}, 'xml')
        ...
        response_text, ctype = \
            decorators.format_conversion({'one': 1, 2: None}, 'json')
